...
void nlight_nb_4k4r_mqtt_update(void)
{
    if (mqttclient != NULL)
    {
...
static void nlight_nb_4k4r_key_task(void *args)
{
...
{
    csro_aw9523b_init();
    xTaskCreate(nlight_nb_4k4r_key_task, "nlight_nb_4k4r_key_task", 2048, NULL, configMAX_PRIORITIES - 7, NULL);
    xTaskCreate(nlight_nb_4k4r_relay_led_task, "nlight_nb_4k4r_relay_led_task", 2048, NULL, configMAX_PRIORITIES - 8, NULL);
}
